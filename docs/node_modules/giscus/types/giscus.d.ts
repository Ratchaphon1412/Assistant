...
declare type Theme = 'light' | 'light_high_contrast' | 'light_protanopia' | 'dark' | 'dark_high_contrast' | 'dark_protanopia' | 'dark_dimmed' | 'transparent_dark' | 'preferred_color_scheme' | `https://${string}` | GenericString;
declare type Lang = 'de' | 'gsw' | 'en' | 'es' | 'fr' | 'id' | 'it' | 'ja' | 'ko' | 'pl' | 'ro' | 'ru' | 'tr' | 'vi' | 'zh-CN' | 'zh-TW' | GenericString;
